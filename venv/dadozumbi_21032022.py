...
def continuar_lancar():
    while True:
        resposta = input("Lançar novamente (s/n)")
...
while True:
 ...
 #       print( jogadores[contador] )
        ...
        if len(dados_relancaveis) + len(bag) < 3:
            ...
            #numero de tiros volta a 0 depois de passar a jogada
